   ...
   <div className=' w-full h-full bg-black overflow-hidden'>
     <div className=' flex items-center justify-center max-w-screen-xl flex-col space-y-6 mx-auto h-screen'>
      <div className=' max-w-screen-xl mx-auto flex items-center flex-col justify-center relative z-20'>
        <h1 className='lg:text-[130px]  font-bold text-transparent bg-clip-text bg-gradient-to-r font-serif from-purple-500 to-purple-400 z-20'>Tune & Talk</h1>
        <p className='lg:text-2xl text-sm font-bold text-white text-center'>Connect through music, vibe as one</p>
    ...
    <button className='bg-gradient-to-r px-10 from-purple-500 to-purple-700
     ...
     <footer className='w-full text-center text-white text-sm py-4 z-30'>
  © {new Date().getFullYear()} Tune & Talk  (created by raj). All rights reserved.
</footer>
